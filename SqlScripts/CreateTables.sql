...
-- -----------------------------------------------------
-- Table `mydb`.`users_like_videos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`users_like_videos` (
...
-- -----------------------------------------------------
-- Table `mydb`.`users_dislike_videos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`users_dislike_videos` (
  `user_id` INT NOT NULL,
  `video_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`users_like_comments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`users_like_comments` (
...
-- -----------------------------------------------------
-- Table `mydb`.`users_dislike_comments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`users_dislike_comments` (
  `comment_id` INT NOT NULL,
  `user_id` INT NOT NULL,
  PRIMARY KEY (`comment_id`, `user_id`),
...
-- -----------------------------------------------------
-- Table `mydb`.`playlists_have_videos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`playlists_have_videos` (
